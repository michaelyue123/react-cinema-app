    ...
    <div className="overview">
      ...
      <div className="overview-column-2">
        <div className="overview-detail">
          ...
          {details.production_companies.map((product) => (
            <div className="product-company" key={uuidv4()}>
              <img src={product.logo_path ? `${IMAGE_URL}${product.logo_path}` : 'http://placehold.it/30x30'} alt="" />
        ...
        {items.map((data) => (
          <div className="overview-detail" key={uuidv4()}>
            <h6>{data.name}</h6>
            <p>
              <a href="!#">{data.value}</a>
            </p>
